...
class EpisodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post episodes_url, params: { episode: { content: @episode.content, description: @episode.description, name: @episode.name } }
    end
  ...
  test "should update episode" do
    patch episode_url(@episode), params: { episode: { content: @episode.content, description: @episode.description, name: @episode.name } }
